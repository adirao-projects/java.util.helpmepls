...
\begin{document}
  ...
  `			\begin{codex}
		...
		\section{Tuples}
			Tuples in Python are like lists, however, they're completely immutable. This means that they \textit{cannot be changed}; once they data they're initialized is in them, they cannot be changed. In order to create a list we simple use parentheses ``()''. T
			
			\lstinputlisting[language=python]{code_examples/chapter_5/tuple.py}
