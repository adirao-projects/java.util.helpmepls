...
\usepackage[]{geometry}
\usepackage{xargs} 
%\usepackage[skip12pt plus1pt, indent=0]{parskip}
\usepackage{parskip}
\doublespacing
\restylefloat{table}
...
\begin{document}
	...
	\chapter{Starting with the basics}  \label{chap:basics}
		...
		\unsure{Might be too python specific, maybe make generic or make 2 editions for java built ins and python built ins}
			\subsection{print()}
				...
				\toadd[inline]{Add a video on the python console}

			\subsection{input()}
				Input is another similar
				\vspace{7cm}\info{Fill info}
	...
	\chapter{Data-structures}  \label{chap:datastructures}
		...
		\section{Advanced Data-structures}
			\subsection{Linked Lists}
				\vspace{15cm}\toadd{Fill info linkedlists}
			\subsection{Stacks}
				\vspace{15cm}\toadd{Fill info stacks}

			\subsection{Queues}
				\vspace{15cm}\toadd{Fill info queues}

			\subsection{Trees}
				\subsubsection{Binary Trees}
					\vspace{15cm}\toadd{Fill info binary trees}

				\subsubsection{Binary Search Trees}
					\vspace{15cm}\toadd{Fill info binary search trees}

				\subsection{Heap}
					\vspace{15cm}\toadd{Fill info heap}

			\subsection{Hashmaps}
				\vspace{15cm}\toadd{Fill info hashmaps}

			\subsection{Matrix}
				\vspace{15cm}\toadd{Fill info matrix}


	\chapter{Simple Algorithms} \label{chap:simple-algorithms}
		\section{Sorting}
			\subsection{Selection Sort}
				\vspace{15cm}\toadd{Fill info slection sorting}

			\subsection{Bubble Sort}
				\vspace{15cm}\toadd{Fill info bubble sort}

			\subsection{Insertion Sort}
				\vspace{15cm}\toadd{Fill info insertion sort}

			\subsection{Quick Sort}
				\vspace{15cm}\toadd{Fill info quick sort}

		\section{Searching}
			\subsection{Linear Search}
				\vspace{10cm}\toadd{Fill info linear search}

			\subsection{Binary Search}
				\vspace{15cm}\toadd{Fill info binary search}
		...
		\section{Intro to Basic Time Complexity}
			...
			\toadd{Time Complexity Graph}
			\vspace{20cm}\toadd{Fill info Time Complexity}
	...
	\chapter{Practicing the basics}	\label{chap:basics-practice}
		...
		\section{Calculator}
			...
			% \end{algorithm}
		\section{Chatbot}
			\vspace{30cm}\toadd{Fill info Chatbot Example}
			
		\section{Management System}
			\vspace{30cm}\toadd{Fill info Management Example}
			
		\section{Task Planner}
			\vspace{30cm}\toadd{Fill info Task Planner Example}
			
	\chapter{Learning some techniques}  \label{chap:techniques}
		\section{Naming Conventions}
			\vspace{20cm}\toadd{Naming Coneventions}

		\section{Error Analysis}
			\vspace{30cm}\toadd{Error Analysis}

		\section{Packages}
			\vspace{20cm}\toadd{Packages}
